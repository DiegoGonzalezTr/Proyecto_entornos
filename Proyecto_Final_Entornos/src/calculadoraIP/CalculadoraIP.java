...
public class CalculadoraIP {
	...
	public CalculadoraIP(int ip_rista1, int ip_rista2, int ip_rista3, int ip_rista4, int mascara_rista1,
		...
		super();
		this.ip_rista1 = ip_rista1;
		this.ip_rista2 = ip_rista2;
		this.ip_rista3 = ip_rista3;
		this.ip_rista4 = ip_rista4;
		this.mascara_rista1 = mascara_rista1;
		this.mascara_rista2 = mascara_rista2;
		this.mascara_rista3 = mascara_rista3;
		this.mascara_rista4 = mascara_rista4;
